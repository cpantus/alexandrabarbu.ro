/**
 * Simple Playwright script to inspect hero-breadcrumb (vanilla JS)
 */
...
(async () => {
  ...
  const contentCheck = await page.evaluate(() => {
    ...
    return {
      title: {
        ...
        visible: isVisible('.c-hero-breadcrumb__title'),
      },
      subtitle: {
        ...
        visible: isVisible('.c-hero-breadcrumb__subtitle'),
      },
      description: {
        exists: !!document.querySelector('.c-hero-breadcrumb__description'),
        visible: isVisible('.c-hero-breadcrumb__description'),
      },
      breadcrumb: {
        exists: !!document.querySelector('.c-hero-breadcrumb__breadcrumb'),
        visible: isVisible('.c-hero-breadcrumb__breadcrumb'),
      },
      ctaButtons: {
        ...
        visible: isVisible('.c-hero-breadcrumb__cta-group'),
      },
      media: {
        ...
        visible: isVisible('.c-hero-breadcrumb__media'),
      }
    };
  });
  ...
  const report = `# Hero Breadcrumb Diagnostic Report
## Page: /despre-mine/
...
- Breadcrumb: ${contentCheck.breadcrumb.exists ? 'Present (visibility controlled by template)' : 'Not configured'}
- Compass: ${contentCheck.media.hasCompass ? 'Yes' : 'No'}

### Issues Found:
${contentCheck.title.visible ? '✅' : '❌'} Title visible
${contentCheck.subtitle.visible ? '✅' : '❌'} Subtitle visible
${contentCheck.description.visible ? '✅' : '❌'} Description visible
${contentCheck.breadcrumb.visible ? '✅' : '❌'} Breadcrumb visible
${contentCheck.ctaButtons.visible ? '✅' : '❌'} CTA buttons visible
...
`;
  ...
  console.log(`   Description visible: ${contentCheck.description.visible ? '✅' : '❌'}`);
