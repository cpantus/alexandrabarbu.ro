...
Trauma is not defined by the event but by how your body and mind responded to that event. The same event can be traumatic for one person and not for another.
{{< /highlight-box >}}
...
Psychological trauma occurs when a person experiences an event or series of events that exceed their capacity to process and integrate the experience. According to van der Kolk (2014), author of the landmark work "The Body Keeps the Score," trauma is not merely a painful memory — it is a reorganization of how the brain and body perceive and respond to the world.

{{< key-fact icon="las la-flask" label="Scientific Evidence" >}}
Research by van der Kolk (2014) and Porges (2011) demonstrates that trauma alters the functioning of the autonomic nervous system, affecting how the body regulates stress, emotions, and relationships. These changes are neurobiological, not merely psychological, which explains why "positive thinking" alone does not heal trauma.
{{< /key-fact >}}
...
{{< callout type="tip" title="Important Consideration" >}}
Trauma can also be indirect. Professionals who work with traumatized individuals (doctors, psychologists, social workers, police officers) can develop secondary or vicarious trauma, experiencing symptoms similar to those of the people they help (Figley, 1995).
{{< /callout >}}
...
{{< step >}}**Social engagement (ventral vagal)** — The optimal state: we feel safe, connected, and capable of relationships. The nervous system functions in balance.{{< /step >}}
{{< step >}}**Fight or flight (sympathetic)** — The body mobilizes for action: the heart beats fast, muscles tense, breathing accelerates. Useful short-term, harmful when chronic.{{< /step >}}
{{< step >}}**Freeze/collapse (dorsal vagal)** — When neither fight nor flight is possible, the body "shuts down": numbness, dissociation, sense of paralysis. This is a protective mechanism, not weakness.{{< /step >}}
{{< /steps >}}
...
- **Amygdala** — Becomes hyperactive, detecting danger where none exists (hypervigilance)
- **Hippocampus** — Its functioning decreases, affecting memory and the ability to distinguish present from past
- **Prefrontal cortex** — Partially deactivates, reducing rational thinking and emotional regulation capacity

{{< key-fact icon="las la-brain" label="Neuroscience" >}}
Neuroimaging research by Shin et al. (2006) shows that during traumatic flashbacks, the brain's language center (Broca's area) partially deactivates. This explains why traumatized individuals often say: "I have no words for what I feel" — literally, the brain makes speech more difficult in these moments.
{{< /key-fact >}}
...
{{< exercise title="Exercise: The Window of Tolerance" >}}
The concept of the "window of tolerance" (Siegel, 1999) describes the optimal zone of activation:

1. **Identify your window**: When you feel calm, connected, and capable — that is your window of tolerance
2. **Notice when you leave it**: When you are above the window (anxiety, agitation, anger) or below it (numbness, detachment, extreme fatigue)
3. **Return to the window**: Use slow breathing (inhale 4 seconds, exhale 6 seconds) to bring yourself back to the optimal zone
4. **Note patterns**: What situations push you out of the window? What helps you return?
...
Trauma is an invisible wound, but its effects are profoundly real. Understanding the mechanisms of trauma is not just an intellectual exercise — it is the first step toward healing. If you recognized yourself in what is described here, know that healing is possible and that you do not have to walk this path alone.
