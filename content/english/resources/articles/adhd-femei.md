...
Women with ADHD are diagnosed on average 10-15 years later than men. Many first receive a diagnosis of anxiety or depression — which are often consequences of undiagnosed ADHD, not the primary cause. If you recognize yourself in this article, you are not alone and it is not your fault.
{{< /highlight-box >}}
...
Early ADHD studies (1970s-1990s) predominantly included boys, creating diagnostic criteria based on the male presentation — visible hyperactivity and disruptive behavior. Research by Quinn and Madhoo (2014), published in The Primary Care Companion for CNS Disorders, shows that girls with ADHD are 3 times less likely to be identified because their symptoms are less "visible" in the classroom.
{{< /key-fact >}}
...
{{< key-fact icon="las la-chart-bar" label="Statistics" >}}
...
{{< callout type="warning" title="Important to know" >}}
Estrogens directly influence dopamine levels in the brain. When estrogen drops, dopamine drops — and ADHD symptoms worsen. This explains why many women notice:
...
{{< exercise title="Awareness Exercise: Mental Load Audit" >}}
Women with ADHD often carry an enormous "mental load" — the invisible management of family and professional life. Do the following exercise:
...
3. Notice how many of these things are "invisible" — no one knows you are managing them
4. Ask yourself: how many can be delegated, automated, or eliminated?

This exercise does not solve the problem, but it makes it visible — the first step toward change.
{{< /exercise >}}

### ADHD-specific burnout in women

{{< steps connected="true" >}}
{{< step >}}**The masking phase:** You compensate for symptoms through extra effort — you function, but at an immense energy cost{{< /step >}}
{{< step >}}**The accumulation phase:** Stress increases, sleep deteriorates, self-criticism intensifies — "why can't I cope like everyone else?"{{< /step >}}
{{< step >}}**The collapse phase:** Burnout, severe anxiety, or depression — the moment when many women see a psychologist and receive an ADHD diagnosis for the first time{{< /step >}}
...
1. **Self-screening:** Complete the ASRS (Adult ADHD Self-Report Scale) — available free online. It is not a diagnosis, but it indicates whether professional evaluation is warranted
...
ADHD in women is not a milder form of ADHD — it is a different form, often harder to identify but equally impactful. If you have spent your life wondering why everything seems harder for you, if you have always felt that you must work twice as hard as others for the same results — it may not be about discipline or character. It may be about the way your brain works.
