...
problem_empathy:
  enable: true
  title: "Ce Probleme Abordăm în Terapia de Cuplu?"
  subtitle: "Înțelegem provocările voastre"
  description: "Relațiile sunt complexe. Aceste provocări sunt reale și afectează fericirea voastră. Nu sunteți singuri."
...
therapeutic_process:
  ...
  subtitle: "Structurat, empatic, orientat spre soluții"
  description: "Terapia de cuplu nu este despre găsirea vinovatului. Este despre înțelegere reciprocă și construirea unei relații mai sănătoase."

  phases:
    - title: "Evaluare Inițială a Relației"
      ...
      activities:
        ...
        - "Chestionare validate (Couple Satisfaction Index, Gottman Assessment)"
        - "Evaluarea stilurilor de comunicare și conflict"
    ...
    - title: "Stabilirea Obiectivelor Comune"
      ...
      activities:
        ...
        - "Stabilirea regulilor de siguranță (respectul reciproc)"
        - "Plan terapeutic personalizat pentru cuplul vostru"

    - title: "Îmbunătățirea Comunicării"
      ...
      activities:
        ...
        - "Identificarea și oprirea \"Cavalerilor Apocalipsei\" (Gottman)"
        - "Teme pentru acasă: conversații structurate zilnice"
        - "Monitorizare progres: cum vă simțiți înțeleși?"

    - title: "Rezolvarea Problemelor Specifice"
      ...
      activities:
        ...
        - "Rezolvarea conflictelor despre bani, copii, socri"
        - "Schimbarea comportamentelor negative (criticare, stonewalling)"
        - "Construirea ritualurilor de conexiune (date nights, ritualuri zilnice)"
    ...
    - title: "Consolidare și Prevenție"
      ...
      activities:
        ...
        - "Identificarea semnelor de avertizare (să știți când să reveniți)"
        - "Întărirea ritualurilor de conexiune"

    - title: "Finalizare sau Terapie de Mentenanță"
      ...
      activities:
        ...
        - "Contact deschis pentru crize sau întrebări"

# Methods Used
methods_used:
  enable: true
  title: "Metodele Pe Care Le Folosesc"
  subtitle: "Abordări validate pentru terapia de cuplu"
  description: "Combin cele mai eficiente metode specifice pentru terapia de cuplu, bazate pe cercetare științifică solidă."
  ...
  methods:
    - title: "Metoda Gottman (Gottman Method Couples Therapy)"
      ...
      best_for:
        - "Conflicte repetitive și escaladare"
        - "Lipsa comunicării sau comunicare toxică"
        - "Pierderea conexiunii emoționale"
        - "Gestionarea diferențelor fundamentale"
      success_rate: "70%+ cupluri raportează îmbunătățire semnificativă (studii Gottman Institute)"
      duration: "15-20 sesiuni pentru probleme moderate"
    ...
    - title: "TCC pentru Cupluri (Cognitive Behavioral Couples Therapy)"
      ...
      best_for:
        - "Gânduri negative și resentimente adânci"
        - "Comportamente repetitive distructive"
        - "Lipsa abilităților de rezolvare a problemelor"
        - "Depresie sau anxietate într-unul sau ambii parteneri"
      success_rate: "60-70% îmbunătățire în satisfacția relațională (meta-analize)"
    ...
    - title: "Terapia Focalizată pe Emoții (Emotionally Focused Therapy - EFT)"
      ...
      best_for:
        - "Lipsa intimității emoționale profunde"
        - "Cicluri de urmărire-retragere (pursue-withdraw)"
        - "Nevoi de atașament nesatisfăcute"
        - "Reconstruire după infidelitate"
      success_rate: "70-75% cupluri își îmbunătățesc semnificativ relația (studii EFT)"
      duration: "15-25 sesiuni"
    ...
    - title: "Terapie pentru Infidelitate și Reconstruirea Încrederii"
      ...
      best_for:
        - "Aventuri emoționale sau fizice recente"
        - "Infidelitate descoperită sau dezvăluită"
        - "Decizii despre continuarea relației"
        - "Reconstruirea încrederii după trădare"
      duration: "20-30 sesiuni, uneori mai mult"
...
testimonials:
  enable: true
  title: "Ce Spun Cuplurile Cu Care Am Lucrat"
  subtitle: "Povești reale de reconstruire"

  items:
    - quote: "Eram pe marginea divorțului după ce am descoperit aventura lui. Terapia cu Alexandra ne-a ajutat să procesăm durerea, să înțelegem ce s-a întâmplat și să reconstruim încrederea. Acum, după 8 luni, relația noastră este mai puternică decât era înainte. Nu credeam că e posibil."
      name: "Elena și Mihai"
      age: "36 și 39 ani"
      service: "Terapie de Cuplu - Infidelitate"
      image: "images/testimonials/couple-elena-mihai.jpg"
      rating: 5

    - quote: "Nu mai comunicam deloc. Fiecare conversație devenea ceartă. Alexandra ne-a învățat tehnici Gottman care au schimbat total modul în care vorbim unul cu altul. Acum ne ascultăm cu adevărat și ne înțelegem. Simt că am regăsit conexiunea."
      name: "Ioana și Andrei"
      age: "31 și 33 ani"
      service: "Terapie de Cuplu - Comunicare"
      image: "images/testimonials/couple-ioana-andrei.jpg"
      rating: 5

    - quote: "Veneam pentru că nu știam dacă să ne căsătorim sau să ne despărțim. Terapia ne-a ajutat să clarificăm ce vrem cu adevărat, să înțelegem diferențele noastre și să decidem împreună. Am ales să continuăm, dar conștient și pregătit, nu din teamă."
      name: "Maria și Alex"
      age: "28 și 30 ani"
      service: "Terapie de Cuplu - Decizii"
...
services_preview_related:
  enable: true
  title: "Alte Servicii Care Vă Pot Ajuta"
  subtitle: "Dacă problemele sunt mai complexe..."
