...
newsletter_signup:
  ...
  description: |
    Primește lunar articole noi, exerciții practice, invitații la workshop-uri și resurse exclusive direct în inbox.
...
cta_standard:
  ...
  title: "Resursele Gratuite Sunt un **Început, Nu o Soluție Completă**"
  description: |
    Aceste resurse pot fi foarte utile, dar nu înlocuiesc terapia personalizată. Dacă te confrunți cu dificultăți
    persistente, anxietate severă, depresie sau orice altă provocare care îți afectează viața, te încurajez
