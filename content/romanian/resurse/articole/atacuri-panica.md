...
{{< callout type="clinical" title="Ce se întâmplă în corp" >}}
...
{{< callout type="warning" title="Cum se auto-întreține panica" >}}
...
{{< highlight-box title="1. Recunoaște ce se întâmplă" >}}
...
{{< exercise title="2. Controlează respirația - Tehnica 4-7-8" >}}
...
{{< exercise title="3. Tehnica grounding 5-4-3-2-1" >}}
...
{{< exercise title="4. Relaxarea musculară rapidă" >}}
...
{{< callout type="tip" title="5. Vorbește-ți cu compasiune" >}}
...
{{< exercise title="1. Ține un jurnal al atacurilor" >}}
...
{{< callout type="clinical" title="2. Expunerea interoceptivă" >}}
...
{{< exercise title="3. Identifică și modifică gândurile catastrofice" >}}
**Întrebări utile:**
...
{{< callout type="warning" title="4. Reduce factorii care contribuie" >}}
...
{{< callout type="tip" title="5. Practică regulat tehnici de relaxare" >}}
...
{{< key-fact icon="las la-brain" label="80-90% rată de succes" >}}
Terapia Cognitiv-Comportamentală (TCC) este tratamentul de primă linie pentru tulburarea de panică, cu rate de succes de 80-90%. În unele cazuri, antidepresivele (ISRS) sau medicamentele anxiolitice pot fi recomandate în combinație cu psihoterapia.
{{< /key-fact >}}
