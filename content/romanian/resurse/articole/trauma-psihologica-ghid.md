...
Trauma nu este definită de eveniment, ci de modul în care organismul și psihicul tău au răspuns la acel eveniment. Același eveniment poate fi traumatic pentru o persoană și nu pentru alta.
{{< /highlight-box >}}
...
Cercetările lui van der Kolk (2014) și ale lui Porges (2011) demonstrează că trauma modifică funcționarea sistemului nervos autonom, afectând modul în care organismul reglează stresul, emoțiile și relațiile. Aceste modificări sunt neurobiologice, nu doar psihologice, ceea ce explică de ce "gândirea pozitivă" singură nu vindecă trauma.
{{< /key-fact >}}
...
{{< callout type="tip" title="Considerație importantă" >}}
Trauma poate fi și indirectă. Profesioniștii care lucrează cu persoane traumatizate (medici, psihologi, asistenți sociali, polițiști) pot dezvolta traumă secundară sau vicariantă, experimentând simptome similare cu cele ale persoanelor pe care le ajută (Figley, 1995).
{{< /callout >}}
...
{{< step >}}**Angajare socială (ventral vagal)** — Starea optimă: ne simțim în siguranță, conectați și capabili de relații. Sistemul nervos funcționează echilibrat.{{< /step >}}
{{< step >}}**Luptă sau fugă (simpatic)** — Organismul se mobilizează pentru acțiune: inima bate rapid, mușchii se tensionează, respirația se accelerează. Util pe termen scurt, dăunător când devine cronic.{{< /step >}}
{{< step >}}**Înghețare/colaps (dorsal vagal)** — Când nici lupta, nici fuga nu sunt posibile, organismul "se închide": amorțeală, disociere, senzație de paralizie. Este un mecanism de protecție, nu de slăbiciune.{{< /step >}}
{{< /steps >}}
...
{{< key-fact icon="las la-brain" label="Neuroștiință" >}}
Cercetările de neuroimagistică ale lui Shin et al. (2006) arată că, în timpul flashback-urilor traumatice, centrul limbajului din creier (aria Broca) se dezactivează parțial. Aceasta explică de ce persoanele traumatizate spun adesea: "Nu am cuvinte pentru ceea ce simt" — literalmente, creierul face vorbirea mai dificilă în aceste momente.
{{< /key-fact >}}
...
{{< exercise title="Exercițiu: Fereastra de toleranță" >}}
Conceptul de "fereastră de toleranță" (Siegel, 1999) descrie zona optimă de activare:

1. **Identifică-ți fereastra**: Când te simți calm/ă, conectat/ă și capabil/ă — aceea este fereastra ta de toleranță
2. **Observă depășirile**: Când ești deasupra ferestrei (anxietate, agitație, furie) sau dedesubt (amorțeală, detașare, oboseală extremă)
3. **Întoarce-te la fereastră**: Folosește respirația lentă (inspir 4 secunde, expir 6 secunde) pentru a te readuce în zona optimă
4. **Notează tiparele**: Ce situații te scot din fereastră? Ce te ajută să te întorci?
